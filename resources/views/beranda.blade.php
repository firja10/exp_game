...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('img/logo_exp.png')}}" rel="icon">
  <link href="{{asset('img/logo_exp.png')}}" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="header fixed-top" data-scrollto-offset="0">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <h1><img src="{{asset('img/logo_exp.png')}}" alt="" id = "logo_exp"> <strong>Exp Game</strong> </h1>  
...
<section id="hero" class="hero carousel  carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
  ...
  <div class="slideshow-container">
    ...
    <div class="mySlides fade">
      ...
      <img src="{{asset('assets/img/hero-carousel/hero-1.webp')}}" style="width:100%">
      ...
      <div class="container">
        <div class="row justify-content-center gy-6">
          ...
          <div class="col-lg-5 col-md-8">
            <img src="{{asset('assets/img/hero-carousel/hero-1.webp')}}" alt="" class="img-fluid img">
          </div>

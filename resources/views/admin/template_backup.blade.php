...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">  <img src="{{asset('img/logo_exp.png')}}" alt="" id = "logo_exp_admin"> &nbsp; <strong>Exp Games</strong></a>
            <!-- Sidebar Toggle-->
        ...
        <div class="modal fade" id="addBtn" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        ...
        <script src="{{asset('sb_admin/js/datatables-simple-demo.js')}}"></script>
    </body>
</html>
